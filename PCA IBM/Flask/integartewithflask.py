...
API_KEY = "-fyY1xH4Q9TuMTWoZbK90i_NM6qncuHbUtc3RljvpTDU"
...
def predict1():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/9c4f4faa-97c4-4cd2-aaf5-fcb8facaf6dc/predictions?version=2022-01-20', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
